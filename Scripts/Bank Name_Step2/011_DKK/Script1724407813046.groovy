...
'Verify Text for IBAN code'
Mobile.verifyElementText(findTestObject('Object Repository/BankName/13_VerifyText - IBAN Code'), 'IBAN Code')

'Set IBAN code'
Mobile.setText(findTestObject('Object Repository/BankName/14_SetIBAN_Code'), '001123998766', 0)
