...
'Select Maybank London'
Mobile.tap(findTestObject('Object Repository/BankName/10_TapOn - MAYBANK LONDON'), 0)

'Take screenshot after selecting Maybank London'
...
'Set Sort Code'
Mobile.setText(findTestObject('Object Repository/BankName/09_SetSortCode - e.g. 001123'), '001123998', 0)
