...
'Select MALAYAN BERHAD NYC Bank'
Mobile.tap(findTestObject('Object Repository/BankName/001_Select - MALAYAN BERHAD NYC'), 0)

'Take screenshot after selecting MALAYAN BERHAD NYC bank'
...
'Verify Element Text for Fed Wire'
Mobile.verifyElementText(findTestObject('Object Repository/BankName/002_VerifyText - FED WIRE'), 'FED WIRE')

'Set Text for Fed Wire'
Mobile.setText(findTestObject('Object Repository/BankName/006_SetText - e.g. 001123'), '001123998', 0)

'Take Screenshot of Fed Wire pop-up'
Mobile.takeScreenshot('C:\\Users\\AMBRAN~1\\AppData\\Local\\Temp\\screenshot6180602770315342364.png')
Mobile.takeScreenshot()
