...
'Verify Text for BSB code'
Mobile.verifyElementText(findTestObject('Object Repository/BankName/11_VerifyText - BSB Code'), 'BSB Code')

'Set BSB code'
Mobile.setText(findTestObject('Object Repository/BankName/android.widget.EditText - e.g. 0123456789'), '012345678910', 0)
