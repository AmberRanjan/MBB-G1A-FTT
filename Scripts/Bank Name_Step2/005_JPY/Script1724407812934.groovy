...
'Select BANK OF FUKUOKA'
Mobile.tap(findTestObject('Object Repository/BankName/12_JPY_Bank - BANK OF FUKUOKA'), 0)

'Take screenshot after selecting BANK OF FUKUOKA'
