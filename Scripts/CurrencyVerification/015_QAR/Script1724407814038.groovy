...
'Set text as Qatar'
Mobile.setText(findTestObject('Object Repository/M25SP5DGA-212/15_Set_Singapore'), 'Qatar', 0)
...
'Select QAR Currency'
Mobile.tap(findTestObject('Object Repository/Countries/19_Tap_QAR - Global Access Account-i (QAR)'), 0)
