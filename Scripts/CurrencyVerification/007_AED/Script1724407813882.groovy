...
'Set text as United Arab Emirates'
Mobile.setText(findTestObject('Object Repository/M25SP5DGA-212/15_Set_Singapore'), 'United Arab Emirates', 0)
...
'Select AED Currency'
Mobile.tap(findTestObject('Object Repository/Countries/11_Tap_AED- Global Access Account-i (AED)'), 0)
