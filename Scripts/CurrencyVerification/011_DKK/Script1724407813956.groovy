...
'Set text as Denmark'
Mobile.setText(findTestObject('Object Repository/M25SP5DGA-212/15_Set_Singapore'), 'Denmark', 0)
...
'Select DKK Currency'
Mobile.tap(findTestObject('Object Repository/Countries/15_Tap_DKK - Global Access Account-i (DKK)'), 0)
