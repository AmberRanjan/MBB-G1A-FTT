...
'Set text as Hong Kong'
Mobile.setText(findTestObject('Object Repository/M25SP5DGA-212/15_Set_Singapore'), 'Hong Kong', 0)
...
'Select HKD Currency'
Mobile.tap(findTestObject('Object Repository/Countries/16_Tap_HKK- Global Access Account-i (HKD)'), 0)
