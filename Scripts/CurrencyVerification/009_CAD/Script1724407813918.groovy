...
'Set text as Canada'
Mobile.setText(findTestObject('Object Repository/M25SP5DGA-212/15_Set_Singapore'), 'Canada', 0)
...
'Select CAD Currency'
Mobile.tap(findTestObject('Object Repository/Countries/13_Tap_CAD - Global Access Account-i (CAD)'), 0)
