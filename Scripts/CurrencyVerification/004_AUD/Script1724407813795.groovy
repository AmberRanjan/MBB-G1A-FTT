...
'Set text as Australia'
Mobile.setText(findTestObject('Object Repository/M25SP5DGA-212/15_Set_Singapore'), 'Australia', 0)
...
'Select AUD Currency'
Mobile.tap(findTestObject('Object Repository/Countries/08_Tap_AUD - Global Access Account-i (AUD)'), 0)

'Take screenshot after selecting GAA AUD '
