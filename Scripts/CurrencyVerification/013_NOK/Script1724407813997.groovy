...
'Set text as Norway'
Mobile.setText(findTestObject('Object Repository/M25SP5DGA-212/15_Set_Singapore'), 'Norway', 0)
...
'Select NOK Currency'
Mobile.tap(findTestObject('Object Repository/Countries/17_Tap_NOK- Global Access Account-i (NOK)'), 0)
