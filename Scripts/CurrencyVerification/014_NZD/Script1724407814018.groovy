...
'Set text as New Zealand'
Mobile.setText(findTestObject('Object Repository/M25SP5DGA-212/15_Set_Singapore'), 'New Zealand', 0)
...
'Select NZD Currency'
Mobile.tap(findTestObject('Object Repository/Countries/18_Tap_NZD - Global Access Account-i (NZD)'), 0)
