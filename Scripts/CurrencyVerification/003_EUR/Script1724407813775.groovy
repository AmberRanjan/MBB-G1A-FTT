...
'Set text as United Kingdom'
Mobile.setText(findTestObject('Object Repository/M25SP5DGA-212/15_Set_Singapore'), 'United Kingdom', 0)
...
'Select EUR Currency'
Mobile.tap(findTestObject('Object Repository/Countries/07_Tap_EUR - Global Access Account-i (EUR)'), 0)
