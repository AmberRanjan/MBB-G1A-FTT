...
'Set text as Brunei Darussalam'
Mobile.setText(findTestObject('Object Repository/M25SP5DGA-212/15_Set_Singapore'), 'Brunei', 0)
...
'Select BND Currency'
Mobile.tap(findTestObject('Object Repository/Countries/12_Tap_BND - Global Access Account-i (BND)'), 0)
