...
'Set text as Switzerland'
Mobile.setText(findTestObject('Object Repository/M25SP5DGA-212/15_Set_Singapore'), 'Switzerland', 0)
...
'Select CHF Currency'
Mobile.tap(findTestObject('Object Repository/Countries/14_Tap_CHF - Global Access Account-i (CHF)'), 0)
