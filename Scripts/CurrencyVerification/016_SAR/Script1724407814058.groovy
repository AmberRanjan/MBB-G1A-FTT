...
'Set text as Saudi Arabia'
Mobile.setText(findTestObject('Object Repository/M25SP5DGA-212/15_Set_Singapore'), 'Saudi Arabia', 0)
...
'Select SAR Currency'
Mobile.tap(findTestObject('Object Repository/Countries/20_Tap_SAR - Global Access Account-i (SAR)'), 0)
