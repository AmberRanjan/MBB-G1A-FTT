...
'Set text as Japan'
Mobile.setText(findTestObject('Object Repository/M25SP5DGA-212/15_Set_Singapore'), 'Japan', 0)
...
'Select JPY Currency'
Mobile.tap(findTestObject('Object Repository/Countries/09_Tap_JPY - Global Access Account-i (JPY)'), 0)
