...
'Set text as Sweden'
Mobile.setText(findTestObject('Object Repository/M25SP5DGA-212/15_Set_Singapore'), 'Sweden', 0)
...
'Select SEK Currency'
Mobile.tap(findTestObject('Object Repository/Countries/21_Tap_SEK - Global Access Account-i (SEK)'), 0)
